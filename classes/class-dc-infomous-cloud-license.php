...
class DC_Infomous_Cloud_License {
	
	/**
	 * Self Upgrade Values
	 */
	// Base URL to the remote upgrade API server
	public $upgrade_url = DC_INFOMOUS_CLOUD_PLUGIN_SERVER_URL; // URL to access the Update API Manager.

	/**
	 * @var string
	 * This version is saved after an upgrade to compare this db version to $version
	 */
	public $api_manager_license_version_name = 'dc-infomous-cloud_license_version';
    ...
    global $DC_Infomous_Cloud;
		...
		if ( is_admin() ) {
			 ...
			 */
			$this->license_software_product_id = $DC_Infomous_Cloud->token;

			/**
			 * Set all data defaults here
			 */
			$this->license_product_id_key 			= 'dc_infomous_cloud_license_product_id';

			/**
			 * Set all software update data here
			 */
			$this->license_plugin_name 			= 'infomous_cloud/infomous_cloud.php'; // same as plugin slug. if a theme use a theme name like 'twentyeleven'
			...
			$this->license_software_version 	= $DC_Infomous_Cloud->version; // The software version
...
function DC_Infomous_Cloud_LICENSE() {
  return DC_Infomous_Cloud_License::instance();
}
